...
if __name__ == "__main__":
    ...
    # morning red
    red.add_schedule("08:00", 5)
    red.add_schedule("08:20", 10)
    red.add_schedule("08:40", 15)
    red.add_schedule("09:00", 20)
    red.add_schedule("09:20", 15)
    red.add_schedule("09:40", 10)
    red.add_schedule("10:00", 5)

    # evening red
    red.add_schedule("18:00", 5)
    red.add_schedule("18:20", 10)
    red.add_schedule("18:40", 15)
    red.add_schedule("19:00", 20)
    red.add_schedule("19:20", 15)
    red.add_schedule("19:40", 10)
